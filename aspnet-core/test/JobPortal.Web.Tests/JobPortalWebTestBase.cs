...
{
    public abstract class JobPortalWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static JobPortalWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(JobPortalWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<JobPortalDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<JobPortalDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<JobPortalDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<JobPortalDbContext, Task<T>> func)
        {
            T result;
